...
function AccountBalance({balance}) {
  ...
  const loadBlockchainData = async() => {
    ...
    for(var i =0; i<total;i++)
    {
      let contribution = await crowdfunding.contributorContributions(account, i+1)
      let contri = parseInt(contribution.toString())
          ...
          <Box p={4}>
            ...
            <Box>
              ...
              >
                ...
                {displayTotal && (
                  <Box>
                  <Typography variant="h4">{ethers.utils.formatUnits(item.pledgedAmt.toString(), "ether")} ETH</Typography>
