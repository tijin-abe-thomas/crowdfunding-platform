...
const Product = ({ item, provider, account, crowdfunding, togglePop }) => {
  ...
  const fetchDetails = async () => {
    ...
    const y = await crowdfunding.campaignContributions(parseInt(item.ID.toString()) , x)
    console.log("contri", await crowdfunding.campaignContributions(parseInt(item.ID.toString()) , x) )
