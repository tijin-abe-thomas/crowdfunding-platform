      ...
      >
        <Grid item md={10} lg={8} mx="auto">
          ...
          <TypographyH1 sx={{ mb: 2 }} variant="h1">
            IE NITK: Decentralised Crowdfunding Platform
          </TypographyH1>
          <TypographyH2
            ...
            fontWeight="normal"
          >
            It is a completely decentralised platform developed by The Institution of Engineers, NITK for Crowdfunding applications.
          </TypographyH2>
          <Button
            component={Link}
